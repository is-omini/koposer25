#############################################################################
# Makefile for building: build/bin/koposer25.app/Contents/MacOS/koposer25
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = koposer251.0.0
DISTDIR = /Users/julie/Documents/project-dev/koposer25/build/obj/koposer251.0.0
...
DESTDIR       = build/bin/
TARGET        = build/bin/koposer25.app/Contents/MacOS/koposer25
...
build/bin/koposer25.app/Contents/MacOS/koposer25:  $(OBJECTS)  
	@test -d build/bin/koposer25.app/Contents/MacOS/ || mkdir -p build/bin/koposer25.app/Contents/MacOS/
...
build/bin/koposer25.app/Contents/PkgInfo: 
	@test -d build/bin/koposer25.app/Contents || mkdir -p build/bin/koposer25.app/Contents
	@$(DEL_FILE) build/bin/koposer25.app/Contents/PkgInfo
	@echo "APPL????" > build/bin/koposer25.app/Contents/PkgInfo
build/bin/koposer25.app/Contents/Info.plist: 
	@test -d build/bin/koposer25.app/Contents || mkdir -p build/bin/koposer25.app/Contents
	@$(DEL_FILE) build/bin/koposer25.app/Contents/Info.plist
	@set -o pipefail && plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.koposer25,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.koposer25,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,koposer25,g" -e "s,@LIBRARY@,koposer25,g" -e "s,\$${EXECUTABLE_NAME},koposer25,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >build/bin/koposer25.app/Contents/Info.plist

all: Makefile \
		build/bin/koposer25.app/Contents/PkgInfo \
		build/bin/koposer25.app/Contents/Info.plist build/bin/koposer25.app/Contents/MacOS/koposer25
...
distclean: clean 
	-$(DEL_FILE) -r build/bin/koposer25.app
