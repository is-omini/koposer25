#############################################################################
# Makefile for building: _build/bin/DreamMoutain.app/Contents/MacOS/DreamMoutain
...
DISTDIR = /Users/julie/Documents/project-dev/koposer25/_build/obj/DreamMoutain1.0.0
...
OBJECTS       = _build/obj/mainDreamMountain.o \
		_build/obj/windowDreamMountain.o \
		_build/obj/appContentDreamMountain.o \
		_build/obj/codeEditorDreamMountain.o \
		_build/obj/filesExplorerDreamMountain.o \
		_build/obj/webViewDreamMountain.o \
		_build/obj/interfaceDreamMountain.o \
		_build/obj/textEditor.o \
		_build/obj/lineNumberArea.o \
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		koposer25.pro src/mainDreamMountain.h \
...
DESTDIR       = _build/bin/
TARGET        = _build/bin/DreamMoutain.app/Contents/MacOS/DreamMoutain
...
_build/bin/DreamMoutain.app/Contents/MacOS/DreamMoutain:  $(OBJECTS)  
	@test -d _build/bin/DreamMoutain.app/Contents/MacOS/ || mkdir -p _build/bin/DreamMoutain.app/Contents/MacOS/
...
_build/bin/DreamMoutain.app/Contents/PkgInfo: 
	@test -d _build/bin/DreamMoutain.app/Contents || mkdir -p _build/bin/DreamMoutain.app/Contents
	@$(DEL_FILE) _build/bin/DreamMoutain.app/Contents/PkgInfo
	@echo "APPL????" > _build/bin/DreamMoutain.app/Contents/PkgInfo
_build/bin/DreamMoutain.app/Contents/Info.plist: 
	@test -d _build/bin/DreamMoutain.app/Contents || mkdir -p _build/bin/DreamMoutain.app/Contents
	@$(DEL_FILE) _build/bin/DreamMoutain.app/Contents/Info.plist
	@set -o pipefail && plutil -convert xml1 -o - MacOs/Info.plist | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.DreamMoutain,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.DreamMoutain,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,icon.icns,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},icon.icns,g" -e "s,@EXECUTABLE@,DreamMoutain,g" -e "s,@LIBRARY@,DreamMoutain,g" -e "s,\$${EXECUTABLE_NAME},DreamMoutain,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >_build/bin/DreamMoutain.app/Contents/Info.plist
_build/bin/DreamMoutain.app/Contents/Resources/icon.icns: MacOs/icon.icns
	@test -d _build/bin/DreamMoutain.app/Contents/Resources/ || mkdir -p _build/bin/DreamMoutain.app/Contents/Resources/
	@$(DEL_FILE) _build/bin/DreamMoutain.app/Contents/Resources/icon.icns
	@$(COPY_FILE) MacOs/icon.icns _build/bin/DreamMoutain.app/Contents/Resources/icon.icns

all: Makefile \
		_build/bin/DreamMoutain.app/Contents/PkgInfo \
		_build/bin/DreamMoutain.app/Contents/Info.plist \
		_build/bin/DreamMoutain.app/Contents/Resources/icon.icns _build/bin/DreamMoutain.app/Contents/MacOS/DreamMoutain
...
distclean: clean 
	-$(DEL_FILE) -r _build/bin/DreamMoutain.app
	-$(DEL_FILE) Makefile
...
compiler_rcc_clean:
compiler_moc_predefs_make_all: _build/moc/moc_predefs.h
compiler_moc_predefs_clean:
	-$(DEL_FILE) _build/moc/moc_predefs.h
_build/moc/moc_predefs.h: /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp
	/Library/Developer/CommandLineTools/usr/bin/clang++ -pipe -stdlib=libc++ -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=14.0 -Wall -Wextra -dM -E -o _build/moc/moc_predefs.h /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp

compiler_moc_header_make_all: _build/moc/moc_interfaceDreamMountain.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) _build/moc/moc_interfaceDreamMountain.cpp
_build/moc/moc_interfaceDreamMountain.cpp: src/include/interfaceDreamMountain.h \
		...
		_build/moc/moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/julie/Documents/project-dev/koposer25/_build/moc/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/julie/Documents/project-dev/koposer25 -I/opt/homebrew/lib/QtWebEngineWidgets.framework/Headers -I/opt/homebrew/lib/QtPrintSupport.framework/Headers -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtWebEngineCore.framework/Headers -I/opt/homebrew/lib/QtQuick.framework/Headers -I/opt/homebrew/lib/QtOpenGL.framework/Headers -I/opt/homebrew/lib/QtSvg.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtQmlMeta.framework/Headers -I/opt/homebrew/lib/QtQmlModels.framework/Headers -I/opt/homebrew/lib/QtQmlWorkerScript.framework/Headers -I/opt/homebrew/lib/QtWebChannel.framework/Headers -I/opt/homebrew/lib/QtQml.framework/Headers -I/opt/homebrew/lib/QtNetwork.framework/Headers -I/opt/homebrew/include -I/opt/homebrew/include/QtQmlIntegration -I/opt/homebrew/lib/QtPositioning.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/17/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib src/include/interfaceDreamMountain.h -o _build/moc/moc_interfaceDreamMountain.cpp
...
_build/obj/mainDreamMountain.o: src/mainDreamMountain.cpp src/mainDreamMountain.h \
		src/include/windowDreamMountain.h \
		src/include/customBarDreamMountain.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o _build/obj/mainDreamMountain.o src/mainDreamMountain.cpp

_build/obj/windowDreamMountain.o: src/include/windowDreamMountain.cpp src/include/windowDreamMountain.h \
		src/include/customBarDreamMountain.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QMainWindow \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qmainwindow.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
...
_build/obj/webViewDreamMountain.o: src/include/webViewDreamMountain.cpp src/include/webViewDreamMountain.h \
		...
		/opt/homebrew/lib/QtWidgets.framework/Headers/QVBoxLayout \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qboxlayout.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o _build/obj/webViewDreamMountain.o src/include/webViewDreamMountain.cpp

_build/obj/interfaceDreamMountain.o: src/include/interfaceDreamMountain.cpp src/include/interfaceDreamMountain.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QPushButton \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qpushbutton.h \
		/opt/homebrew/lib/QtSvg.framework/Headers/QSvgRenderer \
		/opt/homebrew/lib/QtSvg.framework/Headers/qsvgrenderer.h \
		/opt/homebrew/lib/QtGui.framework/Headers/QPainter \
		/opt/homebrew/lib/QtGui.framework/Headers/qpainter.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o _build/obj/interfaceDreamMountain.o src/include/interfaceDreamMountain.cpp

_build/obj/textEditor.o: src/include/system/textEditor.cpp src/include/system/textEditor.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QPlainTextEdit \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qplaintextedit.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
...
_build/obj/lineNumberArea.o: src/include/system/lineNumberArea.cpp src/include/system/lineNumberArea.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o _build/obj/lineNumberArea.o src/include/system/lineNumberArea.cpp

_build/obj/webEngine.o: src/include/system/webEngine.cpp src/include/system/webEngine.h \
		/opt/homebrew/lib/QtWebEngineWidgets.framework/Headers/QWebEngineView \
		/opt/homebrew/lib/QtWebEngineWidgets.framework/Headers/qwebengineview.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o _build/obj/webEngine.o src/include/system/webEngine.cpp

_build/obj/fileSortingAlgorithm.o: src/include/system/fileSortingAlgorithm.cpp src/include/system/fileSortingAlgorithm.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o _build/obj/fileSortingAlgorithm.o src/include/system/fileSortingAlgorithm.cpp
...
_build/obj/customBarDreamMountain.o: src/include/customBarDreamMountain.cpp src/include/windowDreamMountain.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o _build/obj/customBarDreamMountain.o src/include/customBarDreamMountain.cpp

_build/obj/statutAppBarDreamMountain.o: src/include/statutAppBarDreamMountain.cpp src/include/statutAppBarDreamMountain.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QPushButton \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qpushbutton.h \
...
_build/obj/moc_interfaceDreamMountain.o: _build/moc/moc_interfaceDreamMountain.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o _build/obj/moc_interfaceDreamMountain.o _build/moc/moc_interfaceDreamMountain.cpp
