...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/DreamMountain.h src/ui_styles.h src/interface.h src/explorer_files.h src/file.h src/code_editor.h src/web_view.h src/development_tab.h src/html_color_syntax.h $(DISTDIR)/
