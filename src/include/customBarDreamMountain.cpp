...
CustomBarDreamMountain::CustomBarDreamMountain(WindowDreamMountain *main, QWidget *parent) : QWidget(parent) {
	...
	QPushButton* sourceBtn = AppendButtonList(
		"Source",
		nullptr,
		0,
		R"(
	...
	rightButtonList.append(sourceBtn);
	QPushButton* designBtn = AppendButtonList(
		"Design",
		nullptr,
		0,
		R"(
	...
	rightButtonList.append(designBtn);
	CustomBarDreamMountain::UpdateButtonListRight();

	QObject::connect(sourceBtn, &QPushButton::clicked, [this]() {
		windowParentApp->getAppContentDreamMountain()->onCodeEditorVisibilityChanged(true);
	});
	QObject::connect(designBtn, &QPushButton::clicked, [this]() {
		windowParentApp->getAppContentDreamMountain()->onCodeEditorVisibilityChanged(false);
	});
